...
export default function Login() {
  ...
  return (
    <div className="flex items-start flex-col p-6 space-y-4">
      ...
      {/* <Link
        to="/account"
        className="text-center w-full py-2 mt-4 font-semibold text-white rounded-lg bg-[#CBCBCB]"
      > */}
        <button className="cursor-pointer text-center w-full py-2 mt-4 font-semibold text-white rounded-lg bg-[#CBCBCB]" onClick={handleLogin}>
          Login
        </button>
      {/* </Link> */}
    </div>
